        ...
        <div class="carousel-inner ">
            ...
            <div class="row">
              <div class="col-sm-2 col-lg-8">
                <div style="margin-top: 15em">
                  <h1 class="fs-4 fs-md-4 lh-1 text-black" > <b  style=" font-size: 48px; font-family:Poppins"> Kerjakan tes sekarang dan dapatkan rekomendasi dari <span class="text-danger">Konsel</span> tentang kemampuanmu.</b> </h1>
                </div>
              </div>
            </div> 
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-sm-2 col-lg-8">
                <div  style="margin-top: 15em">
                  <h1 class="fs-4 fs-md-4 lh-1 text-black" > <b style=" font-size: 48px; font-family:Poppins"> Dengan bantuan psikolog, menyiapkan pemuda pemudi indonesia dalam menentukan masa depan.</b> </h1>
                </div>
              </div>
            </div> 
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-sm-2 col-lg-8">
                <div  style="margin-top: 15em">
                  <h1 class="fs-4 fs-md-4 lh-1 text-black" > <b  style=" font-size: 48px; font-family:Poppins"> menjadi cerdas dan berkarakter adalah tujuan utama sebuah pendidikan.</b> </h1>
                </div>
              </div>
            </div> 
          </div>
