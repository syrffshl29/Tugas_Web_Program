<footer style="background: #D32E50">
    <div class="container py-2 py-lg-5 ps-md-4 pe-md-4 ps-4 pe-4">
      <div
      ...
      >
        ...
        >
          <img src="{{asset ('templete/assets/img/konselputih.png')}}" width="50%" alt="">
          <p
        ...
        >
          ...
          <div class="row mb-md-2 mt-md-2">
            ...
            <div class="col text-start">
              <p style="height: 14px; font-size: 14px">+62 81225929178<br /></p>
            </div>
          </div>
          <div class="row mb-md-2 mt-md-2">
